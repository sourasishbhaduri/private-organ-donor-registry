...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.secretBloodType) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secretBloodType');
    }
    if (typeof(witnesses_0.secretOrganPledge) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secretOrganPledge');
    }
    if (typeof(witnesses_0.secretClearanceHash) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secretClearanceHash');
    }
  ...
  _secretBloodType_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.secretBloodType(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
  ...
  _secretOrganPledge_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.secretOrganPledge(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
  ...
  _secretClearanceHash_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.secretClearanceHash(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
  ...
  _registerDonor_0(context, partialProofData, donorCommitment_0) {
    ...
    __compactRuntime.assert(age_0 >= 18n,
                            'Donor must be at least 18 years of age');
    __compactRuntime.assert(blood_0 >= 1n && blood_0 <= 8n,
                            'Invalid blood group code (1..8)');
    __compactRuntime.assert(pledge_0 > 0n, 'Must pledge at least one organ');
...
const _dummyContract = new Contract({
  ...
  secretClearanceHash: (...args) => undefined
});
